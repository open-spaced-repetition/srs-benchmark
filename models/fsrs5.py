...
SECS_IVL = False # Placeholder (though FSRS4.5 was the one that used it for init_w)

# Constants from FSRS4.5 used in FSRS5's forgetting_curve, ensure they are available
DECAY = -0.5 # Copied from FSRS4.5, as FSRS5 uses it.
FACTOR = 0.9 ** (1 / DECAY) - 1 # Copied from FSRS4.5
...
class FSRS5(FSRS):
    ...
    wd: float = 1e-5
    n_epoch: int = 5
    default_params_stddev_tensor = torch.tensor( # TODO: DEVICE global? If used in iter.
        [
            6.61,
            9.52,
            17.69,
