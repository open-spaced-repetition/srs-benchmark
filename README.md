...
- Other:
    - LogisticRegression: performs a logistic regression based on 33 features computed from the card history.
...
| Logistic Regression | 34 | 0.3393±0.0042 | 0.0605±0.0010 | 0.7108±0.0023 | IL, FIL, G, SR |
