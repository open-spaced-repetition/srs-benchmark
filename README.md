...
Log Loss and RMSE (bins) measure calibration: how well predicted probabilities of recall match the real data. AUC measures discrimiantion: how well the algorithm can tell two (or more, generally speaking) classes apart.
