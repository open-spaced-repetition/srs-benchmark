...
- FSRS-5: the latest version of FSRS. Unlike the previous versions, it uses the same-day review data. Same-day reviews are used only for training, and not for evaluation.
    ...
    - FSRS-5 preset: FSRS-5 that uses different parameters for cards in different presets.
...
| FSRS-5-preset | 19 | 0.328±0.0082 | 0.050±0.0015 | 0.702±0.0044 |
...
| FSRS-5-preset | 19 | 0.357±0.0044 | 0.073±0.0012 | **0.700±0.0023** |
